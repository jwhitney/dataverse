{**
 * plugis/generic/dataverse/templates/sectionEditorSubmissionManagement.tpl
 *
 * Copyright (c) 2003-2013 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * Subtemplate for submission management table modified to include data citation
 *
 *}
<div id="submission">
...
<table width="100%" class="data">
 ...
 {if $dataCitation}
    <tr>
      <td class="label">{translate key="plugins.generic.dataverse.dataCitation"}</td>
      <td colspan="2" class="value">{$dataCitation|strip_unsafe_html}</td>
    </tr>
 {/if}
</table>
</div>
